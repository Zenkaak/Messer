      ...
      <div className="flex flex-col items-center justify-center min-h-[80vh] bg-gray-50 p-6">
        <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden">
          <div style={{ background: "linear-gradient(160deg,#1a2332 0%,#1e3a5f 100%)" }} className="flex flex-col items-center justify-center pt-12 pb-8 px-6 text-center">
            ...
            <p className="text-blue-300/70 text-sm">Now send payment — our team verifies within 10-30 minutes.</p>
          </div>
          <div className="px-6 py-5 space-y-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-3">
              <p className="text-xs text-blue-700">Payment instructions also sent to your email. Our team verifies within <strong>10-30 minutes</strong>.</p>
            </div>
            <button onClick={() => navigate(`/orders/${step.orderId}`)} className="w-full py-3.5 bg-[#1a2332] text-white font-black text-base rounded-2xl flex items-center justify-center gap-2">
              View Order <ArrowRight size={18} />
            </button>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b border-gray-100 bg-gray-50/60 flex items-center gap-2">
                ...
                <span className="ml-auto text-[10px] text-gray-400 font-medium">Recommended</span>
              </div>
              <div className="px-4 py-4">
                <input
                  type="text"
                  ...
                  placeholder="IMEI, serial number, username, or order ref"
                  className="w-full text-sm text-gray-800 border border-gray-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-300 placeholder:text-gray-300"
                />
                <p className="text-[11px] text-gray-400 mt-1.5">
                  For unlock services, enter the device IMEI. For accounts, enter the username.
            ...
            <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
              ...
              <div className="p-3 space-y-2">
                ...
                <PayMethodCard
                  ...
                  subtitle="BTC · ETH · USDT · 100+ coins — automated, no review"
                  badge={<span className="text-[9px] bg-purple-100 text-purple-700 font-bold px-1.5 py-0.5 rounded-full">AUTOMATED</span>}
                />
                {payMethod === "nowpayments" && (
                  <div className="px-3 pb-1 space-y-2">
                    <div className="bg-purple-50 border border-purple-200 rounded-xl px-3 py-2 text-xs text-purple-700 font-medium flex items-start gap-2">
                      <span className="text-sm">⚡</span>
                      <span><strong>Fully automated</strong> — payment is detected on-chain and your order activates automatically. No manual review needed.</span>
                    </div>
                ...
                <PayMethodCard
                  ...
                  title="Binance Pay"
                  subtitle="Manual — Admin confirms within 10-30 min"
                ...
                {payMethod === "binance_pay" && (
                  <div className="px-3 pb-1">
                    <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-3 space-y-1">
                      ...
                      <p className="text-[10px] text-yellow-700">Label: GSM World — Manual Confirmation</p>
                      <p className="text-[10px] text-gray-500">After placing order, send exact amount. Team verifies within 10-30 min.</p>
                    </div>
                  </div>
                )}
                ...
                <PayMethodCard
                  ...
                  subtitle="Manual transfer — Admin confirms within 10-30 min"
