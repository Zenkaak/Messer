...
══════════════════════════════════════════════════════════════
ABOUT GSM WORLD — TRUST & COMPANY INFO
══════════════════════════════════════════════════════════════
• In business since 2016 — 8+ years serving customers worldwide
• Trusted by thousands of resellers, repair shops, and individual customers
• 24/7 bot support + live human agents during business hours
• Fully digital delivery — codes, unlock confirmations, and files sent via email + order messages
• Secure checkout — multiple payment options including mobile money, crypto, and wallet
• Based in Kenya, serving customers globally
• Verified reseller for major GSM unlock server platforms

══════════════════════════════════════════════════════════════
EXPRESS ORDER (/account/express-order)
══════════════════════════════════════════════════════════════
For registered users who want to order fast:
• Go to /account/express-order (or Account → Express Order)
• Type the product name and IMEI/serial directly — no browsing needed
• Ideal for resellers and repair shops doing multiple orders
• Requires a logged-in account

══════════════════════════════════════════════════════════════
BULK ORDERS (/account/bulk-order)
══════════════════════════════════════════════════════════════
For resellers, repair shops, and volume buyers:
• Go to /account/bulk-order (or Account → Bulk Order)
• Upload a CSV file with product names + IMEI/serial numbers
• Process hundreds of orders at once
• Contact support for volume discounts
• Requires a logged-in account

══════════════════════════════════════════════════════════════
API ACCESS (/account/api)
══════════════════════════════════════════════════════════════
For resellers who want to integrate GSM World into their own panels:
• Go to /account/api (Account → API Access)
• Generate API keys for automated ordering
• REST API supports: product search, order placement, order status, bulk orders
• Webhook support for order status updates
• Requires a logged-in account + API plan

══════════════════════════════════════════════════════════════
WALLET SYSTEM (/account/add-fund)
══════════════════════════════════════════════════════════════
• Add funds once — spend anytime without re-entering payment details
• Top up via: M-Pesa, USDT (manual transfer), or Crypto (NOWPayments, min $13)
• Balance visible in Account → Wallet
• Instant deduction at checkout when wallet is selected
• Best for resellers and repeat customers — no per-order payment hassle
• If balance is insufficient at checkout, bot shows top-up prompt

══════════════════════════════════════════════════════════════
PAYMENT METHODS — FULL DETAIL
══════════════════════════════════════════════════════════════
M-PESA (Kenya):
• Works via STK Push — enter phone number (07XXXXXXXX), confirm PIN on your phone
• Instant settlement — order confirmed within seconds
• Min amount: depends on product price
• Currency: KES (auto-converted from USD, approx ×130)

USDT (Tether):
• Manual transfer — send exact amount to wallet address shown
• Networks: TRC20 (cheaper fees) or ERC20 (higher fees)
• Confirmation required by admin — typically 10–30 minutes
• No minimum, but check network fees

NOWPAYMENTS (Crypto):
• Auto-generated address — valid for 15 minutes only
• Supports: BTC, ETH, USDT TRC20, LTC, BNB, DOGE, and more
• Minimum $13 USD equivalent
• Auto-confirmed on blockchain — no manual admin needed
• ⚠️ CRITICAL: Never send after address expires — funds NOT recoverable

BINANCE PAY:
• Scan QR or use Binance Pay ID shown after order
• Works in 100+ countries, 0% fees
• Near-instant settlement

GSM WORLD WALLET:
• One-click payment from pre-loaded balance
• Instant — no waiting, no external payment needed

══════════════════════════════════════════════════════════════
DELIVERY TIMES — GUARANTEED SLA
══════════════════════════════════════════════════════════════
iPhone carrier unlock:       1–24 hours (some carriers instant on payment)
Samsung network unlock:      1–5 business days (most within 24h)
iCloud Activation Lock:      3–7 business days
iCloud Bypass (A12+):        1–3 business days  
FRP Bypass:                  1–24 hours (usually <2h)
IMEI Check:                  Instant (automated)
Blacklist Removal:           1–3 business days
Gift Cards:                  Instant–1 hour after payment confirmed
Server Credits:              Instant–30 minutes
Tool Activations:            Instant–2 hours
Remote Services:             1–24 hours depending on service

══════════════════════════════════════════════════════════════
REFUND & CANCELLATION POLICY
══════════════════════════════════════════════════════════════
• Cancellation: within 30 minutes of order if status is "pending" or "awaiting verification"
• Refund: if service cannot be completed after payment — full refund issued to wallet
• No refund once service is delivered (digital goods)
• Dispute: message support via order page or WhatsApp within 24h of delivery
• Wrong IMEI or email provided by customer = not eligible for refund

══════════════════════════════════════════════════════════════
RESELLER PROGRAM
══════════════════════════════════════════════════════════════
• Volume discounts available — contact support for reseller pricing
• Resellers get: API access, bulk ordering, priority support, custom pricing
• Requirements: consistent volume (discuss with support)
• Payment: wallet pre-loading preferred (no per-order checkout friction)
• Private label / white-label options available on request

══════════════════════════════════════════════════════════════
CURRENCY GUIDE
══════════════════════════════════════════════════════════════
All prices shown in USD. Approximate conversions:
• 1 USD ≈ 130 KES (Kenyan Shilling) — for M-Pesa users
• 1 USD ≈ 1 USDT (Tether)
• Bitcoin/ETH rates vary — NOWPayments calculates live rate at order time
• UK customers: £1 ≈ $1.27 USD (prices reflect USD equivalent)
• EU customers: €1 ≈ $1.10 USD
...
• Order-specific issues: use order message thread (/orders/[id])
